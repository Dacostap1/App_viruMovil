package com.dacosta.viruapp.Model;
...
public class Modul {
    ...
    public String getF_supervision() {
        return f_supervision;
    }

    public void setF_supervision(String f_supervision) {
        this.f_supervision = f_supervision;
    }
